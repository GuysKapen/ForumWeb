<template>
  <div
    role="button"
    tabindex="0"
    data-e2e="EventContainer-user-1657235215.777"
    id=""
    ...
    <div class="m-0 flex flex-row items-center">
      <div class="flex flex-shrink-0 m-0">
        ...
        >
          <svg
            ...
            data-prefix="fas"
            data-icon="meh-blank"
            class="svg-inline--fa fa-meh-blank fa-w-16 css-1y53wuf"
            role="img"
      ...
      <div>
        ...
        <div class="mx-2 flex justify-end">
          ...
          >
            <div
              data-qa="conversation-message-bubbles_div"
              class="
                m-0
                bg-slate-100
                text-gray-800
            ...
            >
              <div
                class="text-xs"
                :class="elClass"
                style="font-family: Noto Sans; top: 50%"
              >
                {{ message }}
              </div>
            </div>
