<template>
    <footer aria-label="Site Footer" class="bg-white">
        <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
            <div
                class="flex flex-col items-center gap-4 rounded-lg bg-indigo-600 px-6 py-4 shadow-lg sm:flex-row sm:justify-between">
                <strong class="text-base font-bold text-white">
                    Make Your Next Career Move!
                </strong>

                <a class="inline-flex items-center rounded-full border border-white bg-white px-8 py-2 text-indigo-600 hover:bg-transparent hover:text-white focus:outline-none focus:ring active:bg-white/90"
                    href="/">
            ...
            <div class="mt-8 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                <div class="text-center sm:text-left">
                    <p class="text-base font-bold text-gray-900">About Us</p>
                ...
                <div class="text-center sm:text-left">
                    <p class="text-base font-bold text-gray-900">Our Services</p>
                ...
                <div class="text-center sm:text-left">
                    <p class="text-base font-bold text-gray-900">Resources</p>
                ...
                <div class="text-center sm:text-left">
                    <p class="text-base font-bold text-gray-900">Helpful Links</p>
