                                ...
                                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    ...
                                    <div>
                                        <label for="about" class="block text-sm font-medium text-gray-700">
                                            About </label>
                                        <div class="mt-1">
                                            <textarea id="about" name="about" rows="6" v-model="about"
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 flex items-center">
                                            <span
                                                ...
                                                <img src="" alt="cover" class="object-cover h-full w-full">
                                            </span>
        ...
        async updateProfile() {
            ...
            try {
                ...
                if (this.image != null) {
                    ...
                    res = await axios.post(`${serverUrl}/users/${this.user._id}/uploads/image`, form, {
                        headers: {
                ...
                res = await axios.post(`${serverUrl}/users/${this.user._id}/profiles`, { title: this.title, about: this.about, cover: this.cover }, {
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
                        'x-access-token': token,
