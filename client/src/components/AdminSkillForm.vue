        ...
        <div>
            <form enctype="multipart/form-data" @submit.prevent="submit()">
                ...
                <div class="mb-4 px-2 w-full">
                    <div class="field">
                        <div class="control">
                            <label class="block font-semibold text-sm" for="name">Skill name</label>
                ...
                <div class="py-3 text-right px-2 flex justify-between">
                    <router-link :to="{ name: 'field-index' }"
...
export default {
    ...
    methods: {
        ...
        async add(newModel) {
            ...
            try {
                axios
                    .post(`${serverUrl}/skills`, newModel, {
                        headers: {
        ...
        async update(id, newModel) {
            ...
            try {
                axios
                    .put(`${serverUrl}/skills/${id}`, newModel, {
                        headers: {
                            "Content-Type": "application/json",
                            Authorization: `Bearer ${authStore.token}`,
                            "x-access-token": authStore.token,
