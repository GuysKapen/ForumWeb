                ...
                <div class="w-full flex-1 mt-8 flex flex-col items-center">
                    ...
                    <form method="POST" @submit.prevent="signup()">
                        ...
                        <div class="max-w-xs relative mx-auto">
                            ...
                            <div class="input">
                                <label class="required hidden" for="username"><abbr
                                ...
                                <input id="username" type="text" v-model="username"
                                    ...
                                    name="username" required autocomplete="name" autofocus placeholder="Username">
                            ...
                            <div class="input password required user_password">
                                ...
                                <label class="password required hidden" for="user_password"><abbr
                                        title="required">*</abbr>
                                    Password</label>
                            ...
                            <div class="input required user_password">
                                ...
                                <label class="password required hidden" for="password-confirm"><abbr
                                        title="required">*</abbr>
                                    Password</label>
                            ...
                            <div class="w-full d-flex justify-content-center">
                                <button type="submit"
                                    ...
                                    <i class="fa fa-sign-in mr-3 duration-500"></i>Register
                                </button>
