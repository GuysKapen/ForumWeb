                                        ...
                                        <table class="min-w-full divide-y divide-gray-200">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                ...
                                                <tr v-for="(skill, idx) in skills" :key="idx">
                                                    ...
                                                    <td class="text-sm font-medium text-gray-900 px-6">{{ skill.name
                                                    }}</td>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        {{moment(new Date( parseInt( skill._id.substring(0, 8), 16 ) *
                                                        1000 )).format('DD/MM/YYYYY')}}
                                                    </td>
                                                    <td
                                                        class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <router-link :to="{name: 'skill-edit', params: {id: skill._id}}"
    ...
    methods: {
        deleteModel(id) {
            ...
            showConfirmPopup(function () {
                ...
                axios.delete(`${serverUrl}/skills/${id}`, {
                    headers: {
                    ...
                    self.skills = self.skills.filter(item => item._id !== id);
                    createToast('Success delete skill', { type: 'success' })
                })
            })
        }
    }
