                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                ...
                                                <tr v-for="(company, idx) in companies" :key="idx">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        {{ moment(new Date(parseInt(company._id.substring(0, 8), 16) *
                                                    ...
                                                    <td
                                                        ...
                                                        <button
                                                            class="p-3 mx-1 rounded-lg hover:bg-indigo-600 hover:text-white text-gray-400"
                                                            type="button" @click="deleteModel(company._id)">
    ...
    methods: {
        deleteModel(id) {
            ...
            showConfirmPopup(function () {
                ...
                axios.delete(`${serverUrl}/companies/${id}`, {
                    headers: {
                    ...
                    self.companies = self.companies.filter(item => item._id !== id);
