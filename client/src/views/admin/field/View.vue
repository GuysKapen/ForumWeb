                                        ...
                                        <table class="min-w-full divide-y divide-gray-200">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                ...
                                                <tr v-for="(field, idx) in fields" :key="idx">
                                                    ...
                                                    <td class="text-sm font-medium text-gray-900 px-6">{{ field.name
                                                    }}</td>
    ...
    methods: {
        deleteModel(id) {
            ...
            showConfirmPopup(function () {
                ...
                axios.delete(`${serverUrl}/fields/${id}`, {
                    headers: {
                    ...
                    self.fields = self.fields.filter(item => item._id !== id);
                    createToast('Success delete field', { type: 'success' })
                })
            })
        }
    }
