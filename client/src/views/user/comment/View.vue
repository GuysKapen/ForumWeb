                      ...
                      <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="(comment, idx) in comments" :key="idx">
                          ...
                          <td class="
                              ...
                              px-6
                            ">
                            <div v-html="truncate(comment.comment, 60)"></div>
                          ...
                          <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            <router-link :to="{ name: 'user-comment-edit', params: { id: comment._id } }">
                            ...
                            <button class="p-3 mx-1 rounded-lg hover:bg-indigo-600 hover:text-white text-gray-400"
                              type="button" @click="deleteModel(comment._id)">
  ...
  methods: {
    deleteModel(id) {
      ...
      showConfirmPopup(function () {
        const authStore = useAuthStore();
        axios
          .delete(`${serverUrl}/users/${authStore.user._id}/comments/${id}`, {
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${authStore.token}`,
              "x-access-token": authStore.token,
          ...
          .then(function () {
            ...
            createToast("Success delete comment", { type: "success" });
          });
      });
    },
  },
