...
exports.list = function (req, res) {
  ...
  Category.paginate(query, request.getRequestOptions(req), function (err, result) {
...
exports.update = function (req, res) {
  Category.findOneAndUpdate({ _id: req.params.id }, req.body, { new: true }, function (err, item) {
    if (err) return response.sendBadRequest(res, err);
    res.json(item);
  });
};
